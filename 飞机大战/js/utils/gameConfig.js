...
const AIRCRAFT_TYPES = {
    FIGHTER: {
        id: 'fighter',
        name: '战斗机',
        description: '平衡型战机，火力强化',
        stats: {
            speed: 1.0,
            firepower: 1.0,
            defense: 1.0,
            special: 'firepowerBoost'
        },
        color: '#00d4ff',
        unlockCost: { gold: 0, diamond: 0 },
        specialSkill: 'firepowerBoost'
    },
    INTERCEPTOR: {
        id: 'interceptor',
        name: '拦截机',
        description: '高速突袭，锁定追击',
        stats: {
            speed: 1.3,
            firepower: 0.8,
            defense: 0.8,
        ...
        color: '#44ff44',
        unlockCost: { gold: 0, diamond: 60 },
        specialSkill: 'lockOn'
    },
    BOMBER: {
        id: 'bomber',
        name: '轰炸机',
        description: '范围毁灭，地毯式轰炸',
        stats: {
            speed: 0.7,
            firepower: 1.5,
            defense: 1.2,
        ...
        color: '#ff8844',
        unlockCost: { gold: 0, diamond: 120 },
        specialSkill: 'carpetBomb'
    },
    GUARDIAN: {
        id: 'guardian',
        name: '守护者',
        description: '铁壁守护，护盾共享',
        stats: {
            speed: 0.8,
            firepower: 0.9,
            defense: 2.0,
        ...
        color: '#ff44ff',
        unlockCost: { gold: 0, diamond: 180 },
        specialSkill: 'shieldShare'
    },
    STEALTH: {
        id: 'stealth',
        name: '隐形机',
        description: '幽灵刺客，隐形突袭',
        stats: {
            speed: 1.2,
            firepower: 1.3,
            defense: 0.6,
        ...
        color: '#888888',
        unlockCost: { gold: 0, diamond: 250 },
        specialSkill: 'stealthRaid'
    }
};
