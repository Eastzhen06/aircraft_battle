...
class AircraftManager {
    ...
    upgrade(aircraftId, economy) {
        ...
        let cost = UPGRADE_COSTS[currentLevel];
        if (!cost) {
             // Formula for levels > 5: 5000 + increment
             cost = 5000 + (currentLevel - 5) * 3000;
        }
...
window.aircraftManager = new AircraftManager();
window.wingmanManager = new WingmanManager();
